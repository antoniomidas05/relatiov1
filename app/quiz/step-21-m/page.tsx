...
function Step21MContent() {
  const router = useRouter()
  const searchParams = useSearchParams()

  const answerOptions = [
    { id: "no_contact_rule", emoji: "🤫", text: "I use the \"No Contact Rule\"" },
    { id: "he_ignores_me", emoji: "🤷", text: "He ignores me" },
    { id: "business_only", emoji: "🤝", text: "We discuss only \"business\"" },
    { id: "talk_periodically", emoji: "🙂", text: "We talk periodically" },
    { id: "good_friends", emoji: "😊", text: "We are still good friends" },
    { id: "intimate_contact", emoji: "😏", text: "We had intimate contact since the breakup" },
  ]
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("current_relationship", optionId)
    // Navega para a próxima etapa, por exemplo, step-22
    router.push(`/quiz/step-22?${params.toString()}`)
  }
...
export default function Step21M() {
  return (
