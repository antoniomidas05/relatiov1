...
function Step11MContent() {
  const router = useRouter()
  const searchParams = useSearchParams()

  const answerOptions = [
    { id: "rational", emoji: "🧠", text: "More rational" },
    { id: "emotional", emoji: "💖", text: "More emotional" },
    { id: "both", emoji: "🤔", text: "Combination of both" },
  ]
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("ex_personality", optionId)
    // Navega para a próxima etapa, por exemplo, step-12
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="w-full max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-8">Is your Ex more rational or emotional?</h1>
...
export default function Step11M() {
  return (
