...
function Step8HContent() {
  ...
  const answerOptions = [
    ...
    { id: "no", emoji: "😑", text: "No" },
    { id: "not_sure", emoji: "🤔", text: "Not sure" },
  ]
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("emotional_decisions", optionId)
    // Navega para a próxima etapa, por exemplo, step-9
    router.push(`/quiz/step-9-h?${params.toString()}`)
  }
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="w-full max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-8">Lately I've been making more emotional decisions than usual</h1>
...
export default function Step8H() {
  return (
