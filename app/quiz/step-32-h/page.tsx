...
function Step32HContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center p-4 pb-28">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-xl shadow-lg p-5 space-y-4">
            ...
            <div className="bg-red-50 text-red-900 p-4 rounded-lg flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-sm">
                  A high level of emotional separation from your ex can impact your chances of reconnecting. You may
                  struggle with knowing what to say or how to act, as the emotional distance makes it difficult to gauge
                  their feelings. A wrong move could push them further away, causing them to ignore or distance
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            ...
            <StatItem icon="/step32/thunder-blue.svg" title="Current situation" value="Friends" />
...
export default function Step32H() {
  return (
