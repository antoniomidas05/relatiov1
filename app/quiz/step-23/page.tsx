...
function Step23Content() {
  ...
  const answerOptions = [
    { id: "definitely_not", emoji: "🙂", text: "Definitely not" },
    { id: "unknown", emoji: "🤔", text: "I don't know" },
    { id: "probably_yes", emoji: "😔", text: "Probably yes" },
    { id: "definitely_is", emoji: "😫", text: "Definitely is" },
  ]

  // A imagem mostra 19/37, mas manteremos a consistência com 38
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("ex_is_dating", optionId)
    // Navega para a próxima etapa, por exemplo, step-24
    router.push(`/quiz/step-24?${params.toString()}`)
  }
