...
function Step7MContent() {
  const router = useRouter()
  const searchParams = useSearchParams()

  const answerOptions = [
    { id: "no_effort", emoji: "😑", text: "I really don't" },
    { id: "sometimes", emoji: "😏", text: "Only on special occasions" },
    { id: "yes_effort", emoji: "🥰", text: "I do" },
  ]
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("effort_look", optionId)
    // Navega para a próxima etapa, por exemplo, step-8
    router.push(`/quiz/step-8-m?${params.toString()}`)
  }
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="w-full max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-8">Do you make efforts to always look and feel good?</h1>
...
export default function Step7M() {
  return (
