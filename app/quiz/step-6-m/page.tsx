...
function Step6MContent() {
  const router = useRouter()
  const searchParams = useSearchParams()

  const answerOptions = [
    { id: "agree", emoji: "✔️", text: "Agree" },
    { id: "somehow", emoji: "🤔", text: "Somehow agree" },
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("overwhelmed", optionId)
    // Navega para a próxima etapa, por exemplo, step-7
    router.push(`/quiz/step-7-m?${params.toString()}`)
  }
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="w-full max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-8">I've been feeling overwhelmed lately</h1>
...
export default function Step6M() {
  return (
