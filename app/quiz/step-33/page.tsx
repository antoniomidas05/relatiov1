      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center pb-28">
        <div className="w-full max-w-md flex flex-col items-center">
          <p className="text-gray-800 text-lg max-w-sm mb-8 leading-relaxed">
            Every day of <span className="text-red-500 font-semibold">inactivity</span> or sending the{" "}
            <span className="text-red-500 font-semibold">wrong signals</span> to your Ex damage your chances to get{" "}
            {partnerPronoun} back, and you will risk losing {partnerPronoun} to another {otherPartnerGender}...forever
          </p>
