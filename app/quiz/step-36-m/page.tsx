...
function Step36MContent() {
  ...
  const handleContinue = () => {
    ...
    router.push(`/quiz/step-37-m?${params.toString()}`)
  }
...
export default function Step36M() {
  return (
