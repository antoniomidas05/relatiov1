...
const PlanOption = ({ duration, price, originalPrice, isSelected, onClick }: any) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`cursor-pointer border-2 rounded-2xl p-3 flex items-center transition-all ${isSelected ? "border-blue-500 bg-blue-50" : "border-gray-200 bg-white hover:bg-gray-50"}`}
    >
      <div className="flex items-center gap-4 flex-grow">
        <div
          className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${isSelected ? "border-blue-500" : "border-gray-400"}`}
        >
          {isSelected && (
...
function Step50HContent() {
  ...
  const testimonials = [
    ...
    {
      image: "/step50/offer_sophia_b.webp",
      name: "Sophia B",
      location: "US",
      time: "3 days ago",
    ...
    {
      image: "/step50/offer_harper_j.webp",
      name: "Harper J",
      location: "Canada",
      time: "yesterday",
        ...
        <div className="bg-gray-50 p-6 rounded-lg space-y-4">
          ...
          <ul className="space-y-4 pt-2 text-base text-gray-700">
            <li className="flex items-start gap-3">
              <CheckIcon />
              <span>Male behavioral patterns decomposed at their core... And what exactly 'makes guys tick'</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckIcon />
              <span>Key buttons that women need to push in order to engage with a man's hard-wired desires</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckIcon />
              <span>Proven techniques men are literally powerless to resist</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md text-center">
          ...
          <ul className="space-y-5 text-left text-base sm:text-lg text-gray-700">
            <li className="flex items-start gap-4">
              <CheckIcon />
              <span>Your Ex willing to be with you</span>
            </li>
            <li className="flex items-start gap-4">
              <CheckIcon />
              <span>
                No more going to bed in tears...
                <br />
                thinking you've lost everything
              </span>
            </li>
            <li className="flex items-start gap-4">
              <CheckIcon />
              <span>Elevated self-esteem</span>
            </li>
            <li className="flex items-start gap-4">
              <CheckIcon />
              <span>
                Personal step-by-step plan crafted
                <br />
                by professionals to meet your goal
              </span>
            </li>
            <li className="flex items-start gap-4">
              <CheckIcon />
              <span>
                Highly effective life-changing tools <br />
                picked individually for you
              </span>
            </li>
            <li className="flex items-start gap-4">
              <CheckIcon />
        ...
        <div className="bg-gray-50 p-6 rounded-lg space-y-8">
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <p className="text-5xl font-bold text-blue-500 w-20 text-right">95%</p>
              <p className="text-gray-600 text-lg text-left">
                of women using Relatio <span className="text-blue-500 font-semibold">get back</span> together with their
                Ex
              </p>
            </div>
            <div className="flex items-start gap-4">
              <p className="text-5xl font-bold text-blue-500 w-20 text-right">84%</p>
              <p className="text-gray-600 text-lg text-left">
            ...
            <div className="flex items-start gap-4">
              <p className="text-5xl font-bold text-blue-500 w-20 text-right">74%</p>
              <p className="text-gray-600 text-lg text-left">
                had positive changes in their <span className="text-blue-500 font-semibold">self-esteem</span> and the
                way <span className="text-blue-500 font-semibold">men perceive them</span>
              </p>
            </div>
          </div>
          <hr />
