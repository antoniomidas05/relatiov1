...
function Step27MContent() {
  const router = useRouter()
  const searchParams = useSearchParams()

  const answerOptions = [
    { id: "emotional_support", emoji: "🫂", text: "Emotional support" },
    { id: "communication", emoji: "👋", text: "Communication" },
    { id: "intimacy", emoji: "💖", text: "Intimacy" },
    { id: "feeling_desired", emoji: "💥", text: "Feeling desired" },
    { id: "financial_stability", emoji: "💵", text: "Financial stability" },
    { id: "attention_presents", emoji: "🎁", text: "Attention and presents" },
  ]
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    router.push(`/quiz/step-28-m?${params.toString()}`)
  }
...
export default function Step27M() {
  return (
