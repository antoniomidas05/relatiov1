        ...
        <div className="w-full max-w-md flex flex-col items-center">
          ...
          <div className="max-w-sm space-y-4">
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              <span className="text-red-500 font-semibold">Powerful and Uncontrollable</span> she will be completely powerless to resist. She is compelled to call you, text you non-stop, and beg to be with you again, thinking IT WAS HER IDEA IN THE FIRST PLACE
            </p>
