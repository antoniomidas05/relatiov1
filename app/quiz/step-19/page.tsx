...
function Step19Content() {
  ...
  const answerOptions = [
    ...
    { id: "engaged", text: "Engaged" },
    { id: "dating", text: "Dating" },
    { id: "civil_partnership", text: "Civil partnership" },
    { id: "other", text: "Other" },
  ]

  // A imagem mostra 15/37, mas vamos manter a consistência com 38
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("relationship_status", optionId)
    // Navega para a próxima etapa, por exemplo, step-20
    router.push(`/quiz/step-20?${params.toString()}`)
  }
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="w-full max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-8 leading-snug">
            How would you define your relationship status with your ex when you were together?
          </h1>
