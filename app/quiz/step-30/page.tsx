...
function Step30Content() {
  ...
  const handleSelectDifficulty = (difficultyId: string) => {
    setSelectedDifficulties((prev) => {
      ...
      const newSelection = isSelected ? prev.filter((id) => id !== difficultyId) : [...prev, difficultyId]
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className={`font-semibold text-left ${isSelected ? "text-blue-700" : "text-gray-700"}`}>
                      {option.text}
                    </span>
                  </div>
