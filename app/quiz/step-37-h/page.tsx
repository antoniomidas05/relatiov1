...
function Step37HContent() {
  const router = useRouter()
  const searchParams = useSearchParams()

  const answerOptions = [
    { id: "love_at_first_sight", emoji: "🥰", text: "Love at first sight" },
    { id: "fun_spontaneous", emoji: "😊", text: "Fun and spontaneous" },
    { id: "memorable_romantic", emoji: "😌", text: "Memorable and romantic" },
    { id: "nervous_exciting", emoji: "😬", text: "Nervous but exciting" },
    { id: "awkward", emoji: "😅", text: "A bit awkward, honestly" },
  ]
...
export default function Step37H() {
  return (
