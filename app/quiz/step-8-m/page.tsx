...
function Step8MContent() {
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("soulmates_belief", optionId)
    // Navega para a próxima etapa, por exemplo, step-9
    router.push(`/quiz/step-9-m?${params.toString()}`)
  }
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="w-full max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-8">Do you believe in soulmates?</h1>
...
export default function Step8M() {
  return (
