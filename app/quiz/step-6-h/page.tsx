...
function Step6HContent() {
  const router = useRouter()
  const searchParams = useSearchParams()

  const answerOptions = [
    { id: "yes", emoji: "🙄", text: "I can be" },
    { id: "rarely", emoji: "🧐", text: "Rarely, you wouldn't even notice" },
    { id: "never", emoji: "😌", text: "Never" },
  ]
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    params.set("arrogant", optionId)
    // Navega para a próxima etapa, por exemplo, step-7
    router.push(`/quiz/step-7-h?${params.toString()}`)
  }
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="w-full max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-8">Can you sometimes be arrogant?</h1>
...
export default function Step6H() {
  return (
